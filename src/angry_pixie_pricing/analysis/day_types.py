...
def add_day_type_column(df: pd.DataFrame, country_code: str, timestamp_col: str = 'timestamp') -> pd.DataFrame:
    """
...
def get_workday_vs_nonworkday_split(df: pd.DataFrame, country_code: str, timestamp_col: str = 'timestamp') -> tuple[pd.DataFrame, pd.DataFrame]:
    """
...
def analyze_day_type_distribution(df: pd.DataFrame, country_code: str, timestamp_col: str = 'timestamp') -> Dict[str, int]:
    """
