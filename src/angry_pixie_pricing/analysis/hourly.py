...
class HourlyPriceAnalyzer:
    ...
    def compare_workday_vs_nonworkday(self, analysis_results: Dict[str, pd.DataFrame]) -> Dict[str, any]:
        """
        ...
        if 'workday' in analysis_results and 'non_workday' in analysis_results:
            ...
            if workday_features and nonworkday_features:
                comparison['differences'] = {
                    'duck_depth_diff': (workday_features.get('duck_depth', 0) or 0) - (nonworkday_features.get('duck_depth', 0) or 0),
                    'evening_ramp_diff': (workday_features.get('evening_ramp', 0) or 0) - (nonworkday_features.get('evening_ramp', 0) or 0),
                    'price_range_diff': (workday_features.get('price_range', 0) or 0) - (nonworkday_features.get('price_range', 0) or 0)
                }
