...
from .hotel_profiles import KidsHotelProfile
...
class CalibratedProfile(LoadProfile):
    ...
    def __init__(self,
                 ...
                 day_night_split: Optional[tuple] = None,
    ...
    def _apply_day_night_split(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        if current_day_kwh > 0:
            day_adjustment = daily_day_kwh / current_day_kwh
        else:
            day_adjustment = 1.0
            
        if current_night_kwh > 0:
            night_adjustment = daily_night_kwh / current_night_kwh
        else:
