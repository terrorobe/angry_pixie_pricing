...
import numpy as np
from .templates import ProfileTemplate, ProfileType
...
class HotelFacilityMixin:
    ...
    def get_activity_area_load(self, hour: int) -> float:
        ...
        """
        factors = {
            9: 0.5, 10: 0.7, 11: 0.8,  # Morning activities
            14: 0.6, 15: 0.8, 16: 0.9, 17: 0.9,  # Afternoon peak
            18: 0.7, 19: 0.8, 20: 0.6  # Evening activities
        }
...
class KidsHotelProfile(ProfileTemplate, HotelFacilityMixin):
    ...
    def __init__(self, 
                 ...
                 facility_weights: Optional[Dict[str, float]] = None):
...
class DayNightSplitProfile(ProfileTemplate):
    ...
    def __init__(self,
                 ...
                 base_profile: Optional[ProfileTemplate] = None):
