...
class SmartMeterProfile(LoadProfile):
    ...
    def __init__(self, 
        ...
        super().__init__(
            start_date or raw_data.index.min(),
            end_date or raw_data.index.max()
        )
    ...
    @classmethod
    def from_standard_formats(cls, csv_path: Path, format_type: str = 'auto', **kwargs) -> 'SmartMeterProfile':
    ...
    def validate_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'data_quality_score': min(100, 100 * (1 - len(missing_intervals) / len(expected_intervals)))
        }