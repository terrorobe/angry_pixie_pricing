...
class ProfileTemplate:
    ...
    def generate_profile(self, 
                        ...
                        end_date: datetime,
                        peak_power: float,
                        total_consumption: Optional[float] = None) -> pd.DataFrame:
...
class ResidentialProfile(ProfileTemplate):
    ...
    def __init__(self):
        ...
        self.set_hourly_pattern({
            ...
            6: 0.4, 7: 0.6, 8: 0.7, 9: 0.5, 10: 0.4, 11: 0.4,
            12: 0.5, 13: 0.5, 14: 0.4, 15: 0.4, 16: 0.5, 17: 0.7,
            18: 0.9, 19: 1.0, 20: 0.9, 21: 0.7, 22: 0.5, 23: 0.4
        })
...
class CommercialProfile(ProfileTemplate):
    ...
    def __init__(self):
        ...
        self.set_hourly_pattern({
            ...
            12: 0.9, 13: 0.95, 14: 1.0, 15: 1.0, 16: 0.95, 17: 0.8,
...
class IndustrialProfile(ProfileTemplate):
    ...
    def __init__(self):
        ...
        self.set_hourly_pattern({
            0: 0.4, 1: 0.4, 2: 0.4, 3: 0.4, 4: 0.4, 5: 0.5,
            6: 0.7, 7: 0.9, 8: 1.0, 9: 1.0, 10: 1.0, 11: 1.0,
